  ...
  return (
    <form onSubmit={handleFormSubmit}>
      <div className="relative flex max-w-md rounded-full border border-gray-300 bg-white shadow-sm transition-colors hover:border-gray-400 [&:has(input:focus)]:border-gray-400">
        ...
        <button
          type="submit"
          className="my-1 mr-1 flex max-w-fit items-center justify-center space-x-2 whitespace-nowrap rounded-full bg-secondary px-3 py-2 text-xs text-gray-100 sm:px-5 sm:text-sm"
        >
